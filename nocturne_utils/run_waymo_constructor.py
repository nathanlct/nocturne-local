...
def main():
    ...
    parser.add_argument("--file", type=str, default='/checkpoint/eugenevinitsky/waymo_open/motion_v1p1/uncompressed/scenario/training/training.tfrecord-00997-of-01000')
