...
//     for (const auto* obj : candidates) {
//       if (obj != sourceObj) objects.push_back(dynamic_cast<const
//       Object*>(obj));
//     }
...
//     kinetic_objects.push_back(dynamic_cast<const
//     KineticObject*>(objects[i]));
//   }
...
//       sourceObj, viewAngle, viewDist, maxNumVisibleRoadPoints,
//       road_point_bvh);
//   const size_t n = objects.size();
